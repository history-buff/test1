...
function buyToCart(){
	...
	location.href="${path}/cartServlet?method=buyToCart&buynum="+n+"&pid="+${product.pid};
...
<div class="AreaR" style="width:950px;">
	...
	<div id="goodsInfo" class="clearfix">
		...
		<div class="imgInfo">
			<!-- 当前显示的大图 -->
			<a href="http://localhost:8080/myday20_supermarket/${product.pimage}"
				id="zoom1" class="MagicZoom MagicThumb">
				<img src="http://localhost:8080/myday20_supermarket/${product.pimage}"
		...
		<div class="textInfo">
			...
			<ul class="ul2 clearfix">
				...
				<li class="clearfix">
					<dd>
						<strong>商品分类：</strong> ${product.cid}
					</dd>
				</li>
			...
			<ul class="bnt_ul">
				<li class="clearfix">
					<dd>
						<strong>购买此商品可使用：</strong><font class="f4">${product.shop_price*10} 积分</font>
					</dd>
				</li>
				<li class="clearfix">
					<dd>
				...
				<%--添加到购物车 --%>
				<li class="padd">
					<a href="javascript:void(0);" onclick="buyToCart();">
						...
						<form action="javascript:;" onsubmit="submitComment(this)"
							...
							<table width="710" border="0" cellspacing="5" cellpadding="0">
								<tr>
									...
									<td width="631">tangtang</td>
								</tr>
								<tr>
									<td align="right">E-mail：</td>
									<td><input type="text" name="email" id="email"
										maxlength="100" value="369811823@qq.com" class="inputBorder" />
									</td>
								</tr>
								<tr>
